...
public final class STTabbar: UITabBar {
    ...
    @IBInspectable public var tabbarColor: UIColor = UIColor.yellow
    ...
    private func setupMiddleButton() {
        ...
        centerButton.imageEdgeInsets = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: centerButton.bounds.width - centerButton.bounds.height)
        centerButton.imageView?.layer.cornerRadius = centerButton.bounds.height/2.0
